...
pub async fn save_temp_file(path_type: PathType, path: &str, temp_file: rocket::fs::TempFile<'_>) -> Result<(), crate::Error> {
    use tokio::io::AsyncReadExt as _;

    let operator = CONFIG.opendal_operator_for_path_type(path_type).await?;

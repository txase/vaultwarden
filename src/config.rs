...
fn validate_config(cfg: &ConfigItems) -> Result<(), Error> {
    ...
    if cfg._enable_smtp {
        ...
        if (cfg.smtp_host.is_some() || cfg.use_sendmail || cfg.use_aws_ses) && !cfg.smtp_from.contains('@') {
...
impl Config {
    ...
    pub async fn update_config(&self, other: ConfigBuilder) -> Result<(), Error> {
    ...
    async fn update_config_partial(&self, other: ConfigBuilder) -> Result<(), Error> {
        ...
        self.update_config(builder).await
    }
